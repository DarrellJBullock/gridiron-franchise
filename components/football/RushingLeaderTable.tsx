...
import type { RushingLeaderRow } from "@/lib/stats/leaders";

export function RushingLeaderTable({ rows }: { rows: RushingLeaderRow[] }) {
  return (
    <Card className="p-5">
      <p className="mb-3 text-xs font-semibold uppercase tracking-wide text-text-muted">Rushing Leaders</p>
      {rows.length === 0 ? (
